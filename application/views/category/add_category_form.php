    ...
    <div id="add_category" class="tab-pane fade">
      ...
      <?php echo form_open('Ccategory/insert_category', array('class' => 'form-vertical', 'id' => 'insert_category')) ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  class="form-control" name ="category_description" id="category_description" placeholder="<?php echo display('description') ?>"></textarea>
                        ...
                        <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                   <input style="float:right" type="submit" id="add-category" class="btn btn-success btn-large" name="add-category" value="<?php echo display('save') ?>" />
                            </div>
                        </div>
