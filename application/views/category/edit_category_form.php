                ...
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Ccategory/category_update',array('class' => 'form-vertical', 'id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                        <label for="category_description" class="col-sm-3 col-form-label"><?php echo display('description') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <textarea  class="form-control" name ="category_description" id="category_description" placeholder="<?php echo display('description') ?>">{category_description}</textarea>
                                <!-- <input class="form-control" name ="category_description" id="category_description" type="text" placeholder="<?php echo display('description') ?>"  required=""> -->
                            </div>
                         </div>
                        ...
                        <div class="col-sm-6">
                                <input style="float:right" type="submit" id="add-Customer" class="btn btn-success btn-large" name="add-Customer" value="<?php echo display('save_changes') ?>" />
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
