...
;
            ...
            <div style="display: flex;">
                <a class="btn btn-small" style="background-color: antiquewhite;"><i class="fa fa-qrcode"></i></a>                  
                ...
                <a class="btn btn-small" style="background-color: antiquewhite;"><i class="fa fa-pencil"></i></a>                  
            ...
            <input id="autocomplete_customer_id" class="customer_hidden_value" type="hidden" name="customer_id" value="{customer_id}">
             ...
             <input id="date" class="" type="hidden" name="invoice_date" value="<?php echo date('Y-m-d');?>">
              <?php
               ...
               <a href="#" style="background-color: antiquewhite;" class="btn btn-small" aria-hidden="true" data-toggle="modal" data-target="#cust_info"><i class="ti-plus m-r-2"></i></a>
                                          ...
                                          <div class="row">
                                           ...
                                           <div style="display: flex;">
                                            <div style="display: flex;flex-direction: column;"> 
                                             <label for="net_total" class="col-form-label"><?php echo display('net_total'); ?>:</label>
                                              
                                                <input type="text" id="n_total" class="form-control text-right guifooterfixedinput" name="n_total" value="0" readonly="readonly" placeholder="" />
                                                <input type="hidden" name="baseUrl" class="baseUrl" value="<?php echo base_url(); ?>" id="baseurl"/>
                                            </div>
                                            <div style="display: flex;flex-direction: column;"> 
                                            <label for="date" class="col-form-label"><?php echo display('paid_ammount') ?>:</label>
                                            
                                                <input type="text" id="paidAmount" onkeyup="invoice_paidamount();" class="form-control text-right guifooterfixedinput" name="paid_amount" placeholder="0.00" tabindex="13" autocomplete="off" />
                                            </div>
                                            <div style="display: flex;flex-direction: column;">                                             
                                                 <label for="date" class="col-form-label"><?php echo display('due') ?>:</label>
                                                    <input type="text" id="dueAmmount" class="form-control text-right guifooterfixedinput" name="due_amount" value="0.00" readonly="readonly" />
                                                </div>
